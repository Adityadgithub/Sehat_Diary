...
class Medicalinsurance extends StatefulWidget {
  const Medicalinsurance({Key? key}) : super(key: key);

  @override
  State<Medicalinsurance> createState() => _MedicalinsuranceState();
}
    ...
    return SafeArea(
      ...
      body: Container(
        ...
        child: Column(children: [
          Brochure(
            image: "assets/images/insurance/bg/companies/medical.png",
